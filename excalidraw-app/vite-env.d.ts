...
interface ImportMetaEnv {
  ...
  VITE_APP_STORAGE_SIGNER_URL: string;
  VITE_APP_DRAWSY_BACKEND_URL: string;
  VITE_APP_DRAWSY_PREVIEW_ORIGIN: string;
  VITE_APP_DRAWSY_LIBRARY_BASE_URL: string;
  VITE_APP_DRAWSY_LIBRARY_CATALOG_URL: string;
